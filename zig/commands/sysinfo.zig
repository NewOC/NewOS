...
pub fn execute() void {
    ...
    common.printZ("  _   _                ____   _____ \n");
    common.printZ(" | \\ | |              / __ \\ / ____|\n");
    common.printZ(" |  \\| | _____       | |  | | (___  \n");
    common.printZ(" | . ` |/ _ \\ \\ /\\ / / |  | |\\___ \\ \n");
    common.printZ(" | |\\  |  __/\\ V  V /| |__| |____) |\n");
    common.printZ(" |_| \\_|\\___| \\_/\\_/  \\____/|_____/ \n");
    common.printZ("\n");
    ...
    print_entry("OS Version", versioning.NEWOS_VERSION, COLOR_LABEL, COLOR_VALUE, COLOR_BG);
